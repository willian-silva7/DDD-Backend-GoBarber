...
let listProvListProviderDayAvailability: ListProviderDayAvailabilityService;

describe('ListProviderMonthAvailability', () => {
  beforeEach(() => {
    fakeAppointmentsRepository = new FakeAppointmentsReposipory();
    listProvListProviderDayAvailability = new ListProviderDayAvailabilityService(
  ...
  it('should be able to list the day availability from provider', async () => {
    ...
    const availability = await listProvListProviderDayAvailability.execute({
      provider_id: 'John Doe',
      year: 2020,
      month: 5,
      day: 21,
